...
<div class="search">
            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="curriculumName">
                        <Input type="text" v-model="searchForm.curriculumName" placeholder="课程名称" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="作业名称" clearable style="width: 150px" />
                    </Form-item>
    ...
    <Modal v-model="uploadModal" title="作业上传" draggable :mask="false" footer-hide width="1000">
        <Form :label-width="120" label-position="left">
            <Row :gutter="16">
                <Col span="24">
                <FormItem label="作业文件">
                    <upload-file-input v-model="uploadFile" placeholder="请上传作业文件..." style="width:100%"></upload-file-input>
                </FormItem>
                </Col>
                <Col span="24">
                <Divider>
                    <Button @click="uploadAssignmentFx" :loading="uploadLoading" type="success">提交作业</Button>
                </Divider>
                </Col>
            </Row>
        </Form>
...
export default {
        ...
        return {
            ...
            columns: [
                ...
                },
                {
                    ...
                    sortable: false,
                    render: (h, params) => {
                        if (params.row.file1 == undefined || params.row.file1 == "") {
                            return h("div", [
                                h(
                                    "span", {
                                        style: {
                            ...
                            return h("img", {
                                ...
                                on: {
                                    click: () => {
                                        this.showFile(params.row.file1);
                                    },
                                },
                            });
                        }
                ...
                },
                {
                    ...
                    sortable: false,
                    render: (h, params) => {
                        if (params.row.file2 == undefined || params.row.file2 == "") {
                            return h("div", [
                                h(
                                    "span", {
                                        style: {
                            ...
                            return h("img", {
                                ...
                                on: {
                                    click: () => {
                                        this.showFile(params.row.file2);
                                    },
                                },
                            });
                        }
    ...
    methods: {
        ...
        uploadAssignmentFx() {
            ...
            uploadAssignment({
                id: that.uploadObj.id,
                file: that.uploadFile
            }).then(res => {
        ...
        getDataList() {
            this.loading = true;
            getAssignmentList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
