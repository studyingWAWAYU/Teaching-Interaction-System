    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="作业附件" prop="file1">
                <Button @click="downFile(form.file1)" type="success" v-show="form.file1 != ''">下载</Button>
            </FormItem>
            <FormItem label="完成附件" prop="file2">
                <Button @click="downFile(form.file2)" type="success" v-show="form.file2 != ''">下载</Button>
            </FormItem>
            <Form-item class="br">
