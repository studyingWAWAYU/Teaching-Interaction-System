            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="userName">
                        <Input type="text" v-model="searchForm.userName" placeholder="学生姓名" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="workUser">
                        <Input type="text" v-model="searchForm.workUser" placeholder="分配人" clearable style="width: 150px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getTimetableList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
