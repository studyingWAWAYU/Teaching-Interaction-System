            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="name">
                        <Input type="text" v-model="searchForm.name" placeholder="教师姓名" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="level">
                        <Select v-model="searchForm.level" placeholder="教师级别" clearable style="width: 150px">
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getTeacherDataList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
