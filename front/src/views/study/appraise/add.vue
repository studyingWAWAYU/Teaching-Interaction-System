    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="评价时间" prop="time">
                <Input v-model="form.time" clearable style="width:570px" />
            </FormItem>
            <Form-item class="br">
    ...
    methods: {
        ...
        handleSubmit() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    addAppraise(this.form).then(res => {
