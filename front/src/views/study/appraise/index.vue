            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="userName">
                        <Input type="text" v-model="searchForm.userName" placeholder="评价人" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="content">
                        <Input type="text" v-model="searchForm.content" placeholder="评价内容" clearable style="width: 150px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getAppraiseList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
