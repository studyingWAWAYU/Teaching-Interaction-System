<template>
<div>
    <Alert type="success" show-icon banner>温馨提示：该图数据来源自课程作业！</Alert>
                ...
                statistic: {
                    title: {
                        ...
                        customHtml: (container, view, datum) => {
                            ...
                            const text = datum ? datum.title : '课程质量分析模块';
                    ...
                    content: {
                        ...
                        customHtml: (container, view, datum, data) => {
                            ...
                            const text = datum ? ` ${datum.value}份` : ` ${data.reduce((r, d) => r + d.value, 0)}份`;
