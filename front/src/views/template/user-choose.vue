...
<div class="user-choose">
    ...
    <Collapse simple class="collapse">
        <Panel name="1">
            Selected
            <span class="select-count">{{selectUsers.length}}</span> person(s)
            <p slot="content">
    ...
    <Drawer title="Select User" closable v-model="userModalVisible" width="800" draggable>
        ...
        <Alert show-icon>
            Selected
            <span class="select-count">{{selectUsers.length}}</span> item(s)
    ...
    methods: {
        ...
        chooseUser(v) {
            ...
            if (flag) {
                ...
                this.$emit("on-change", this.selectUsers);
                this.$Message.success(`User ${v.nickname} added successfully`);
            }
        },
        clearSelectData() {
            this.selectUsers = [];
        ...
        handleCancelUser(e, id) {
            ...
            this.$emit("on-change", this.selectUsers);
            this.$Message.success("Selected user deleted successfully");
        }
    },
    mounted() {
        this.getUserDataList();
